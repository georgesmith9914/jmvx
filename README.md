...
running command...
$ jmv (--version)
jmvx/0.0.75 win32-x64 node-v16.15.0
$ jmv --help [COMMAND]
USAGE
  $ jmv COMMAND
...
...
_See code: [dist/commands/init.ts](https://github.com/joinmyverse-cli/joinmyverse-cli/blob/v0.0.75/dist/commands/init.ts)_
...
_See code: [dist/commands/publish.ts](https://github.com/joinmyverse-cli/joinmyverse-cli/blob/v0.0.75/dist/commands/publish.ts)_
<!-- commandsstop -->
* [`jmv help [COMMAND]`](#jmv-help-command)
