...
running command...
$ jmv (--version)
jmvx/0.0.70 win32-x64 node-v16.15.0
$ jmv --help [COMMAND]
USAGE
  $ jmv COMMAND
...
...
_See code: [dist/commands/init.ts](https://github.com/joinmyverse-cli/joinmyverse-cli/blob/v0.0.70/dist/commands/init.ts)_
